...
#     # 3. Make a prediction for each pedestrian
...
#         else:
#             # Fallback for unknown age, can be handled as an average or median
...
#     base_dir = Path(__file__).resolve().parents[2]  # Goes up from src/Code to capstone
#     csv_output_path = base_dir / 'logs' / 'Detections' / f'detection_log_{timestamp}.csv'
#     # csv_output_path = f'.../logs/detection_log_{timestamp}.csv' # Corrected path to be relative
...
#             user_df = pd.DataFrame({
#                 'Age': [user_age],
#                 # Replace 'unknown' with a gender that the model knows.
#                 # This prevents the KeyError. 'Male' is a safe default.
